...
set noxtics
set noytics
set title 'DET plot for /home/xinchi/Kaldi-pytorch-QNN/Kaldi_baseline/exp/TIMIT_LSTM_fmllr_combine_290_3500/decode_TIMIT_test_out_dnn2/score_10/ctm_39phn.filt'
set nokey
...
plot [-3.290527:3.290527] [-3.290527:3.290527] \
 "/home/xinchi/Kaldi-pytorch-QNN/Kaldi_baseline/exp/TIMIT_LSTM_fmllr_combine_290_3500/decode_TIMIT_test_out_dnn2/score_10/ctm_39phn.filt.det.dat.00" using 2:1 title "/home/xinchi/Kaldi-pytorch-QNN/Kaldi_baseline/exp/TIMIT_LSTM_fmllr_combine_290_3500/decode_TIMIT_test_out_dnn2/score_10/ctm_39phn" with lines 1
set ytics
set xtics
set size 1.0, 1.0
set key
